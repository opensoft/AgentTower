...
- [ ] T013 [US2] Create the new skip-counter module exposing a **dual-surface** API (corrected per analyze M-API-SHAPE + M-CONST-CASE — TDD-revealed by T010's concrete test contract):
